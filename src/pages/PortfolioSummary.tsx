...
const PortfolioSummary = ({ riskScore, experienceLevel, timeline, onBack, onCustomize }: PortfolioSummaryProps) => {
  ...
  const exportToPDF = () => {
    ...
    if (isFreeUser) {
      ...
      doc.text('Generated with PortfoliX.ai — AI-Powered Investment Portfolios', 105, 287, { align: 'center' });
      
      toast({
        title: "Free Trial Portfolio Saved",
        description: "You've used your 1 free portfolio save. Upgrade for unlimited saves and watermark-free exports.",
      });
    } else {
      toast({
