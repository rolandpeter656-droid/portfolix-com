      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-14 sm:h-16">
          ...
          <Link to="/" className="flex-shrink-0">
            <h1 className="text-xl sm:text-2xl font-sans-bold text-gradient cursor-pointer hover:opacity-80 transition-opacity">PortfoliX</h1>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            ...
            <Link to="/institutions" className="text-sm xl:text-base text-muted-foreground hover:text-foreground transition-colors">
              For Institutions
            </Link>
